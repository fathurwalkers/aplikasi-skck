...
Route::group(['prefix' =>'/dashboard', 'middleware' => 'ceklogin'], function () {
    ...
    Route::get('/laporan-detail', [BackController::class, 'laporan_detail'])->name('laporan-detail');
    Route::get('/laporan-hapus', [BackController::class, 'laporan_hapus'])->name('laporan-hapus');
