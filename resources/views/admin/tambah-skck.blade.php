                ...
                <form action="{{ route('post-tambah-skck') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <select id="inputState" class="form-control" name="jenis_keperluan_pembuatan">
                                    <option selected="null" disabled>Pilih jenis keperluan pembuatan skck...</option>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12 mt-2 mb-2">
                            ...
                            <div class="form-check">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukkan Jawaban anda... " name="jenis_pidana_value_a" required autofocus>
                            ...
                            <div class="form-check">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><span style="color:red;">* </span>Jawaban : </label>
                                    <input type="text" class="form-control" placeholder="Masukkan Jawaban anda... " name="jenis_pidana_value_b" required autofocus>
                                    {{-- <small class="form-text text-muted">contoh : Risky Yatno</small> --}}
                                </div>
                            </div>
                            <div class="form-check">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><span style="color:red;">* </span>Jawaban : </label>
                                    <input type="text" class="form-control" placeholder="Masukkan Jawaban anda... " name="jenis_pidana_value_c" required autofocus>
                                    {{-- <small class="form-text text-muted">contoh : Risky Yatno</small> --}}
                                </div>
                            </div>
                            <div class="form-check">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><span style="color:red;">* </span>Jawaban : </label>
                                    <input type="text" class="form-control" placeholder="Masukkan Jawaban anda... " name="jenis_pidana_value_d" required autofocus>
                                    {{-- <small class="form-text text-muted">contoh : Risky Yatno</small> --}}
                                </div>
                            </div>
                            <div class="form-check">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><span style="color:red;">* </span>Jawaban : </label>
                                    <input type="text" class="form-control" placeholder="Masukkan Jawaban anda... " name="jenis_pidana_value_e" required autofocus>
                                    {{-- <small class="form-text text-muted">contoh : Risky Yatno</small> --}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Masukkan Kabupaten..." name="kabupaten">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><span style="color:red;">* </span>Kebangsaan : </label>
                                <input type="text" class="form-control" placeholder="Masukkan Kebangsaan..." name="kebangsaan_ayah">
                                <small class="form-text text-muted">contoh : INDONESIA </small>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><span style="color:red;">* </span>Pekerjaan : </label>
                                <input type="text" class="form-control" placeholder="Masukkan Pekerjaan..." name="pekerjaan_ayah">
                                <small class="form-text text-muted">contoh : PNS</small>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><span style="color:red;">* </span>Alamat : </label>
                                <input type="text" class="form-control" placeholder="Masukkan Alamat Sekarang..." name="alamat_sekarang_ayah">
